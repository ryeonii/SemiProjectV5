<%@ page pageEncoding="UTF-8" %>
    ...
    <div id="main">
        ...
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                <li class="nav-item">
                    <a class="nav-link" href="intro.html">프로젝트소개</a></li>
                <li class="nav-item">
                    <a class="nav-link active" >회원가입</a></li>
                <li class="nav-item">
            ...
            <div class="row margin30">
                ...
                <div class="col-11">
                    ...
                    <div class="form-group row">
                        ...
                        <span class="col-form-label col-7 text-danger">6~16자의 영문 소문자, 숫자와 특수기호(_)만 사용할 수 있습니다.</span>
                    </div><!-- 아이디 -->

                    <div class="form-group row">
                        <label class="col-2 col-form-label text-right" for="uid">비밀번호</label>
                        <input type="password" class="form-control col-2 border-info"
                               name="pwd" id="pwd" maxlength="16">
                        <span class="col-form-label col-7">6~16자의 영문 소문자, 숫자와 특수기호(_)만 사용할 수 있습니다.</span>

                    </div><!-- 비밀번호 -->

                    <div class="form-group row">
                        <label class="col-2 col-form-label text-right" for="repwd">비밀번호확인</label>
                        <input type="password" class="form-control col-2 border-info"
                    ...
                    <div class="form-group row">
                        ...
                        &nbsp;
                        <input type="text" class="form-control col-4 border-info"
                               name="addr2" id="addr2" maxlength="3" readonly>
                    </div><!-- 주소 -->

                    <div class="form-group row">
                        <div class="input-group">
                            <label class="col-2 col-form-label text-right"
                               for="addr1">전자우편 주소</label>
                    ...
                    <div class="form-group row" style="margin-top: 85px;">
                            ...
                            <button type="button" id="joinokbtn" class="btn btn-primary" id="joinokbtn">
            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-3">
                            <label for="dong" class="text-right text-danger">
                                검색하실 주소의 동이름을
                                입력하세요
                            </label>
                        </div>
                        <div class="col-4">
                            <input type="text" id="dong" name="dong" class="form-control borer-danger">
                        </div>
                        <div class="col-3">
