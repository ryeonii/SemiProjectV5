                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="male" name="genter"
...
<script>
    let checkbtn = document.getElementById('name');
    ...
    checkbtn.addEventListener('click', function () {
        if(name.value.trim() == '') alert('이름을 입력하세요!!');
        ...
        else location.href='/verifyme.html';
    })
</script>
<script>
