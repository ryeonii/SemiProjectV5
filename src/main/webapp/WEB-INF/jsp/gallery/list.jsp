<%@ page pageEncoding="UTF-8" %>
    ...
    <div id="main">
        <div class="margin30">
            <h1><i class="fa fa-picture-o fa-2x">갤러리</i></h1>
            <hr>
        </div> <!--타이틀-->
            ...
            <div class="col-12">
               <ul class="list-inline">
                   <li class="list-inline-item">
                       <a href="gallery/view.html"><img src="img/dgr.png" class="img-thumbnail"></a></li>
                   <li class="list-inline-item">
                       <a href="gallery/view.html"><img src="img/dgr.png" class="img-thumbnail"></a></li>
                   <li class="list-inline-item">
                       <a href="gallery/view.html"><img src="img/dgr.png" class="img-thumbnail"></a></li>
                   <li class="list-inline-item"><img src="img/dgr.png" class="img-thumbnail"></li>
                   <li class="list-inline-item"><img src="img/dgr.png" class="img-thumbnail"></li>
                   <li class="list-inline-item"><img src="img/dgr.png" class="img-thumbnail"></li>
                   <li class="list-inline-item"><img src="img/dgr.png" class="img-thumbnail"></li>
                   <li class="list-inline-item"><img src="img/dgr.png" class="img-thumbnail"></li>
